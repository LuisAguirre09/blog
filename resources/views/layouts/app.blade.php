                ...
                <div class="mbr-table">
                    <div class="mbr-table-cell">
                        ...
                        <div class="navbar-brand">
                            ...
                            <a class="navbar-caption text-white" href="{{ url('/') }}">BlogLaravelL</a>
                        </div>
                    ...
                    <div style="margin-top: 15px; ">
                        <form class="form-inline" action="{{url('/buscador')}}" method="GET">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" id="" name="busqueda" placeholder="Burcar">
                                
                            </div>
                            <button style="margin-top: 10px" type="submit" class="btn btn-warning btn-sm">Buscar</button>
                        </form>
                    </div>
                        ...
                        <ul class="nav-dropdown collapse pull-xs-right nav navbar-nav navbar-toggleable-sm" id="exCollapsingNavbar">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    @endforeach
                                    {{-- <div class="dropdown">
                                        <a class="dropdown-item dropdown-toggle" data-toggle="dropdown-submenu" href="https://mobirise.com/">
                                            Trendy blocks
                                        </a>

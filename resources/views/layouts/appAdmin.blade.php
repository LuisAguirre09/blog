        ...
        <div class="container-fluid">
            <div class="mbr-table">
              <div class="mbr-table-cell">
                    @if(auth()->check())
                        <p style="font-size: 18px; text-align:left; color: white; font-weight: bold; margin: 0; margin-top: 20px;">Bienvenido: {{Auth::user()->name}}</p>
                    @endif
                ...
                <div class="mbr-table-cell">
                    ...
                    <ul class="nav-dropdown collapse pull-xs-right nav navbar-nav navbar-toggleable-xl" id="exCollapsingNavbar">
                      ...
                      <li>
                        <a class="nav-link link" href="{{url('/admin/articulos-borrados')}}" aria-expanded="false">Articulos Borrados</a>
                      </li>
                      <li>
